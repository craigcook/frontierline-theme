  ...
  <div class="content">
    ...
    <div class="nav-mozilla">
      ...
      <aside class="nav-global-fxdownload">
        <a href="https://www.mozilla.org/firefox/channel/desktop/?utm_source=<?php echo frontierline_blog_domain(); ?>&amp;utm_medium=referral&amp;utm_campaign=blog-nav#nightly" rel="external" class="button button-green"><?php _e('Download Firefox Nightly', 'frontierline'); ?></a>
      </aside>
    </div>
