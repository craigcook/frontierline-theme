  ...
  <div class="content">
    ...
    <div class="nav-mozilla">
      ...
      <?php if (get_theme_mod('frontierline_firefox_button') === '1') : ?>
        <li class="nav-global-fxdownload"><a href="https://www.mozilla.org/firefox/new/?utm_source=<?php echo frontierline_blog_domain(); ?>&amp;utm_medium=referral&amp;utm_campaign=blog-nav" rel="external" class="button button-green"><?php _e('Download Firefox', 'frontierline'); ?></a></li>
      <?php else : ?>
